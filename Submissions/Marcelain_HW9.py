...
fig, ax = plt.subplots()
ax.plot(temp_weekly['Temperature'].tail(20), '-r', label='Temperature', alpha=.8)
#ax.plot(train['flow'], 'b:', label='training')
ax.set(title="Temperature Time Series - Weekly", xlabel="Date", 
        ylabel="Weekly Avg Temp [F]")
ax.legend()
...
fig, ax = plt.subplots()
ax.plot(flow_weekly['flow'].tail(20), '-b', label='Flow', alpha=.8)
#ax.plot(train['flow'], 'b:', label='training')
ax.set(title="Stream Flow Time Series - Weekly", xlabel="Date", 
        ylabel="Weekly Avg Flow [cfs]")
ax.legend()
plt.xticks(visible=True, rotation=90)
# an example of saving your figure to a file
fig.set_size_inches(6,4)
fig.savefig("flow_timeseries.png")
...
print('Week 8: ',flow_prediction[0].round(1), "cfs")
print('Week 9: ',flow_prediction[1].round(1), "cfs")
print('Week 10: ',flow_prediction[2].round(1), "cfs")
print('Week 11: ',flow_prediction[3].round(1), "cfs")
print('Week 12: ',flow_prediction[4].round(1), "cfs")
print('Week 13: ',flow_prediction[5].round(1), "cfs")
print('Week 14: ',flow_prediction[6].round(1), "cfs")
print('Week 15: ',flow_prediction[7].round(1), "cfs")
